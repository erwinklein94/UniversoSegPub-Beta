...
const REMUNERACAO_FONTES_OFICIAIS = {
  ...
  pmgo: {
    nome: 'Legisla Goiás — Lei GO nº 23.235/2025 — subsídios PMGO/CBMGO; PMGO — Estrutura Organizacional 2026',
    url: 'https://legisla.casacivil.go.gov.br/api/v2/pesquisa/legislacoes/110397/pdf'
  },
  pcgo: {
    nome: 'Legisla Goiás — Lei GO nº 23.235/2025 e Lei GO nº 15.397/2005; PCGO — Estrutura Organizacional',
    url: 'https://legisla.casacivil.go.gov.br/api/v2/pesquisa/legislacoes/110397/pdf'
  },
  ppgo: {
    nome: 'Legisla Goiás — Lei GO nº 23.235/2025; DGPP/GO — cargos, ocupantes e portal oficial',
    url: 'https://legisla.casacivil.go.gov.br/api/v2/pesquisa/legislacoes/110397/pdf'
  },
  sc_auxilio: {
...
function getAdicionaisRemuneracaoResumo(inst, linha = {}) {
  ...
  if (inst === 'pmgo') {
    return linha.benefDesc || 'PMGO: subsídio cadastrado conforme Lei GO nº 23.235/2025; auxílio, indenizações, escalas, diárias, fardamento, funções e demais rubricas dependem de lei, ato administrativo e contracheque; não foram somados automaticamente.';
  }
  if (inst === 'pcgo') {
    return linha.benefDesc || 'PCGO: subsídio cadastrado conforme Lei GO nº 23.235/2025; Delegado Substituto usa referência do edital oficial 008/2022 e exige conferência na Lei GO nº 15.397/2005, revisões e contracheque. Plantões, auxílios e indenizações não foram somados automaticamente.';
  }
...
function calcularRemuneracaoTabelada(inst, cargo) {
  ...
  if (isPoliciaPenal(inst)) {
    ...
    remuneracao = padrao;
    beneficios = 0;
    criterio = cargo.criterio || 'Tabela de subsídios da PMGO conforme Lei GO nº 23.235/2025; conferir Portal da Transparência/GO, Diário Oficial/GO e contracheque individual.';
    benefDesc = cargo.benefDesc || 'Auxílios, adicionais, indenizações, escalas, fardamento, diárias e gratificações dependem de lei, ato administrativo e contracheque; não foram somados automaticamente.';
    fonteKey = cargo.fonteKey || 'pmgo';
    badge = cargo.badge || 'Lei 23.235/2025';
  } else if (inst === 'pcgo') {
    remuneracao = padrao;
    beneficios = 0;
    criterio = cargo.criterio || 'Tabela de subsídios da PCGO conforme Lei GO nº 23.235/2025; Delegado deve ser conferido também na Lei GO nº 15.397/2005, revisões gerais e contracheque.';
    benefDesc = cargo.benefDesc || 'Plantões, auxílios, indenizações, diárias, gratificações e diferenças individuais dependem de lei, ato administrativo e contracheque; não foram somados automaticamente.';
    fonteKey = cargo.fonteKey || 'pcgo';
    badge = cargo.badge || 'Lei 23.235/2025';
  } else if (inst === 'pmerj') {
...
const HEADER_INSTITUICOES_RESUMO = {
  ...
  pmgo: { criacao: 'Lei GO nº 8.033/1975 · Lei GO nº 15.668/2006 · Lei GO nº 23.235/2025', ativaLabel: 'Efetivo ativo: conferir PMGO/Portal da Transparência · tabela de subsídios cadastrada', reservaLabel: 'Reserva/inativos: GOIASPREV e folha estadual', totalLabel: 'Quadro e efetivo: conferir PMGO, Diário Oficial/GO e Portal da Transparência', relacaoLabel: 'Relação depende de efetivo ativo consolidado', populacao: 7423629, governador: 'Daniel Vilela', comando: 'Coronel PM Marcelo Granja — Comandante-Geral', atualizado: 'Atualizado em 30/04/2026' },
  pcgo: { criacao: 'Lei Estadual nº 185/1898 · Lei GO nº 16.901/2010 · Lei GO nº 23.235/2025', ativaLabel: 'Quadro legal: Agente 3.299, Escrivão 2.309, Papiloscopista 298; efetivo ativo deve ser conferido', reservaLabel: 'Inativos: GOIASPREV e folha estadual', totalLabel: 'Quadro de cargos PCGO estruturado pela Lei GO nº 16.901/2010 e alterações', relacaoLabel: 'Relação depende de efetivo ativo consolidado', populacao: 7423629, governador: 'Daniel Vilela', comando: 'Delegado André Gustavo Corteze Ganga — Delegado-Geral', atualizado: 'Atualizado em 30/04/2026' },
  ppgo: { criacao: POLICIAS_PENAIS_INFO.ppgo.criacao, ativa: 3693, ativaLabel: POLICIAS_PENAIS_INFO.ppgo.efetivoAtivoLabel, reservaLabel: POLICIAS_PENAIS_INFO.ppgo.reservaLabel, totalLabel: POLICIAS_PENAIS_INFO.ppgo.totalLabel, relacaoLabel: POLICIAS_PENAIS_INFO.ppgo.relacaoLabel, populacao: 7423629, governador: 'Daniel Vilela', comando: POLICIAS_PENAIS_INFO.ppgo.direcao, atualizado: POLICIAS_PENAIS_INFO.ppgo.atualizado }
};
...
function mudarInstituicao(novaInstituicao) {
  ...
  const configs = {
    ...
    pmgo: { titulo: "PMGO", desc: "Polícia Militar de Goiás", cor: "#1f7a4d", alertaPrev: "PMGO: conferir sistema de proteção social dos militares estaduais, GOIASPREV, Lei GO nº 8.033/1975, Lei GO nº 15.668/2006, Lei GO nº 23.235/2025, regra de ingresso, reserva remunerada, reforma e contracheque." },
    pcgo: { titulo: "PCGO", desc: "Polícia Civil de Goiás", cor: "#4b5563", alertaPrev: "PCGO: conferir Lei Orgânica GO nº 16.901/2010, Lei GO nº 23.235/2025, Lei GO nº 15.397/2005 para Delegado, GOIASPREV, cargo, classe, padrão, tempo em atividade policial e regra de aposentadoria aplicada." },
    ppgo: { titulo: "PPGO", desc: POLICIAS_PENAIS_INFO.ppgo.nome, cor: "#596b2d", alertaPrev: `${POLICIAS_PENAIS_INFO.ppgo.sigla}: ${POLICIAS_PENAIS_INFO.ppgo.previdencia} ${POLICIAS_PENAIS_INFO.ppgo.vantagens}` }
  };
