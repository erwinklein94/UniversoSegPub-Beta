/* =======================================================
   ...
   Remove os ajustes experimentais de fundo/zoom/layout e aplica uma
   composição limpa para desktop e mobile: logo, texto, seletor e resumo
   sem sobreposição.
   ======================================================= */
...
(function organizarCabecalhoPortal() {
  ...
  function inserirCssCabecalho() {
    ...
    style.textContent = `
      ...
      .site-header .header-institution-main {
        display: grid !important;
        grid-template-columns: minmax(280px, .92fr) minmax(360px, 1.38fr) !important;
        gap: 18px !important;
      ...
      .site-header .header-current-identity {
        ...
        background-image: linear-gradient(145deg, rgba(255,255,255,.08), rgba(9,12,17,.18)) !important;
      }
      ...
      .site-header .header-fact,
      .site-header .header-leadership-item,
      .site-header .header-update-note {
        min-width: 0 !important;
      ...
      .site-header .header-fact span,
      .site-header .header-leadership-item span {
        display: block !important;
      ...
      .site-header .header-fact strong,
      .site-header .header-leadership-item strong {
        display: block !important;
        min-width: 0 !important;
      ...
      .site-header .header-inst-selector select,
      .site-header #instituicao_header {
        width: 100% !important;
        min-width: 0 !important;
      ...
      @media (max-width: 760px) {
        ...
        .site-header .header-current-copy p,
        #header-active-name {
          font-size: clamp(.94rem, 3.9vw, 1.18rem) !important;
          line-height: 1.08 !important;
        }
      ...
      @media (max-width: 390px) {
        ...
        .site-header .header-current-copy strong,
        #header-active-sigla {
          font-size: clamp(1.55rem, 8.4vw, 2.25rem) !important;
        }
  ...
  window.setTimeout(aplicar, 600);
  window.setTimeout(aplicar, 1400);
}());
